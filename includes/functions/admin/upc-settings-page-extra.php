...
upc_settings_extra">
                <h3><?php _e( 'Help Us Spread the Word!', 'upc-coupon' ); ?></h3>
                <p><?php _e( 'Hey, if you like using this plugin, could you please do me a BIG favor and give it a 5-star rating on WordPress? Just to help us spread the word. <br>~ Jayanthi', 'upc-coupon' ); ?></p>
                <div class="
...
upc_settings_extra">
                <h3><?php _e( 'Keep in touch!', 'upc-coupon' ); ?></h3>
                <p><?php _e( 'Sign up to get plugin updates news, WordPress tips and more! We hate spam  just as much as you do. We promise we wil NEVER EVER spam.', 'upc-coupon' ); ?></p>
