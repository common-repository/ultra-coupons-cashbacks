...
if ( ! class_exists( 'UPC_Template_Loader' ) ) {
...
UPC_Template_Loader constructor.
		 *
		 * @since 1.2
		 */
		public function __construct() {

			$this->plugin_directory          = UPC_Plugin::instance()->plugin_dir_path;
